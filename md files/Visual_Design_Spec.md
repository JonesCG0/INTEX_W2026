...
The live frontend now uses this visual direction for the public home page, donor-facing impact dashboard, privacy policy page, donor sign-up flow, and authenticated admin/staff portal. Use the tokens, typography, and spacing below as the source of truth when extending those surfaces.
