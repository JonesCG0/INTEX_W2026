...
- **Typography:**
  - _Yeseva One (Google Fonts)_ for hero headlines, section titles, and impact numbers on all public pages
  - _Geist (Vercel)_ for all admin UI, body content, forms, tables, navigation, and supporting text
- **Component libraries:**
