    ...
    public MlPipelineStore(IOptions<AzureMlOptions> options, AzureMlJobClient azureMlJobClient, IWebHostEnvironment environment)
    {
        ...
        [
            ...
            new PipelineDefinition(
                ...
                OutputFileName: "health_wellbeing_trajectory_metrics.csv",
                PrimaryMetricLabel: "Best ROC AUC",
                PrimaryMetricColumn: "test_roc_auc",
            ...
            new PipelineDefinition(
                ...
                PrimaryMetricColumn: "positive_case_progress_next_month_score",
